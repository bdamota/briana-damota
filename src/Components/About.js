      ...
      <div className="row">
         <div className="six columns main-col col text-center">
            ...
            <div className="aboutInfo">
              <p>I have a passion for people and telling diverse stories that reflect both our unique and shared experiences. I've spent 10+ years working with clients to create authentic and compelling broadcast, digital and branded content that resonates with general market and multicultural audiences.</p>
            ...
            <p>When I'm not working, I most recently can be found in my garden, cooking, DIY'ing, starting a puzzle, or walking my dog.</p>
            </div>
            </div>
